...
echo 'deb http://download.opensuse.org/repositories/devel:/kubic:/libcontainers:/stable:/cri-o:/1.23/xUbuntu_20.04/ /'| tee /etc/apt/sources.list.d/devel:kubic:libcontainers:stable:cri-o:1.23.list
